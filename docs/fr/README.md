...
> 💡 **[AIPOCH Open-Science v0.30.1 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : septembre 2026)_. AIPOCH Open-Science v0.30.1 peaufine la façon dont les changements sont examinés et gérés : les aperçus de mise à jour des compétences s'affichent dans une visionneuse de diff de source avec surbrillance, les conversations latérales s'ouvrent en brouillons qui héritent du modèle de la conversation, un utilitaire de réinitialisation autonome pour Windows efface les données endommagées entre les installations, les sélecteurs d'étiquettes gagnent la recherche et la création au clavier, et la licence du projet est affichée pendant l'installation. Les approbations de plans de session survivent aux expirations MCP, les liaisons d'artefacts vérifiées sont restaurées, et des corrections du connecteur gnomAD, de la place de marché de compétences et de l'extraction PDF complètent le tout. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
