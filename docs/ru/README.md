...
> 💡 **[Вышла AIPOCH Open-Science v0.30.1](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.30.1 дорабатывает механизмы просмотра и управления изменениями: предпросмотры обновлений навыков отображаются как подсвеченный просмотр различий исходного кода, боковые обсуждения открываются черновиками, наследующими модель беседы, автономная утилита сброса для Windows очищает повреждённые данные между установками, средства выбора тегов получают поиск и создание с клавиатуры, а лицензия проекта показывается при установке. Одобрения планов сессии выдерживают таймауты MCP, проверенные привязки артефактов восстанавливаются, а исправления коннектора gnomAD, маркетплейса навыков и извлечения PDF дополняют выпуск. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
