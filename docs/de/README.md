...
> 💡 **[AIPOCH Open-Science v0.30.1 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im September 2026)_. AIPOCH Open-Science v0.30.1 verfeinert, wie Änderungen geprüft und verwaltet werden: Aktualisierungsvorschauen von Fähigkeiten werden in einem hervorgehobenen Quell-Diff-Betrachter dargestellt, Nebengespräche öffnen sich als Entwürfe, die das Modell des Gesprächs erben, ein eigenständiges Windows-Zurücksetzungswerkzeug bereinigt beschädigte Daten zwischen Installationen, Tag-Auswahllisten erhalten Tastatursuche und -erstellung, und die Projektlizenz wird während der Installation angezeigt. Freigabesperren von Sitzungsplänen überstehen MCP-Zeitüberschreitungen, verifizierte Artefaktbindungen werden wiederhergestellt, und Korrekturen am gnomAD-Konnektor, am Fähigkeiten-Marktplatz und an der PDF-Extraktion ziehen sich durch die gesamte Version. Weitere Details finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).
