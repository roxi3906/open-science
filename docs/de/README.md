...
> 💡 **[AIPOCH Open-Science v0.27.0 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im September 2026)_. AIPOCH Open-Science v0.27.0 erweitert den Literatur-Arbeitsbereich und lässt langwierige Arbeit im Hintergrund laufen: Importieren Sie viele PDFs in einem Durchgang mit Fortschritt pro Datei und Wiederholung, führen Sie Notebook- und Befehlszeilen-Jobs im Hintergrund aus, die Ergebnisse automatisch übermitteln, und stützen Sie sich auf eine breite Stabilitätsrunde für die Literatur, die clientsübergreifende Synchronisierung, die Verlagerung des Datenablageorts und die Importintegrität abdeckt. Zentrale Anwendungsfähigkeiten bleiben dauerhaft aktiviert, die kopflose CLI und das Task SDK erhalten eine Konnektorverwaltung, Mermaid-Diagramme werden flüssiger dargestellt, und kopflose Linux-Bereitstellungen erhalten einen ausdrücklichen Dateispeicher für Anmeldedaten. Weitere Details finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).
