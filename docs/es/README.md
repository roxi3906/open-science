...
> 💡 **[AIPOCH Open-Science v0.27.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.27.0 amplía el espacio de trabajo de literatura y permite que el trabajo largo se ejecute en segundo plano: importe muchos PDF en una sola pasada con progreso y reintento por archivo, ejecute trabajos de Notebook y de shell en segundo plano que entregan los resultados automáticamente, y cuente con una amplia pasada de estabilidad de la literatura que cubre la sincronización entre clientes, la reubicación de datos y la integridad de la importación. Las habilidades de aplicación centrales permanecen siempre habilitadas, la CLI sin interfaz gráfica y el Task SDK estrenan gestión de conectores, los diagramas mermaid se representan con mayor fluidez, y las implementaciones de Linux sin interfaz gráfica incorporan un almacén explícito de credenciales en archivo. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.
